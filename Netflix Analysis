/*Shows how many movies there are in the netflix_titles_info table.*/ 
SELECT Count(*) AS movie_count 
FROM   "netflix_titles_info"; 

/*Shows when the most recent batch of TV shows and/or movies was added.*/ 
SELECT Max(Date(date_added)) AS most_recent 
FROM   "netflix_titles_info"; 

/*Lists all the movies and TV shows in alphabetical order.*/ 
SELECT title 
FROM   "netflix_titles_info" 
ORDER  BY title; 

/*Shows who the director is for the movie The Starling.*/ 
SELECT director, 
       title 
FROM   "netflix_titles_info" 
...
/*Shows the oldest movie in the netflix_titles_info table and what year it was released.*/ 
SELECT title, 
       release_year 
FROM   "netflix_titles_info" 
...
/*The above PostgreSQL queries utilize the following Netflix data:*/ 
...
'Sukollawat Kanarot | Sushar Manaying | Pavarit Mongkolpisit | Sahajak Boonthanakit | Suthipongse Thatphithakkul | Bhasaworn Bawronkirati | Daweerit Chullasapya | Waratthaya Wongchayaporn | Kittiphoom Wongpentak | Abhicha Thanachanun | Nophand Boonyai | Kittipong Khamsat | Arisara Wongchalee | Jaytiya Naiwattanakul | Pantipa Arunwattanachai | Panupan Jantanawong | Kungtap Saelim | Phumphat Chartsuriyakiat | Issara Veranitinunt | Keerati Sivakuae | Panjai Sirisuwan | Supranee Charoenpol | Suda Chuenban | Visaka Banhansupavat | Pitchatorn Santinatornkul'
            ...
            ('s13', 
             'Christian Schwochow', 
'Luna Wedler | Jannis Niewohner | Milan Peschel | Edin Hasanovic | Anna Fialova | Marlon Boess | Victor Boccard | Fleur Geffrier | Aziz Dyab | Melanie Fouche | Elizaveta Maximova'
), 
            ('s14', 
             'Bruno Garotti', 
'Klara Castanho | Lucca Picon | Julia Gomes | Marcus Bessa | Kiria Malheiros | Fernanda Concon | Gabriel Lima | Caio Cabral | Leonardo Cidade | Jade Cardozo'
), 
            ('s15', 
             NULL, 
             NULL), 
...
'Logan Browning | Brandon P. Bell | DeRon Horton | Antoinette Robertson | John Patrick Amedori | Ashley Blaine Featherson | Marque Richardson | Giancarlo Esposito'
            ...
            ('s17', 
             'Pedro de Echave Garcia | Pablo AzoriÂ­n Williams', 
             NULL), 
            ('s18', 
             NULL, 
'Luis Ernesto Franco | Camila Sodi | Sergio Goyri | Samadhi Zendejas | Eduardo Yanez | Sonya Smith | Alejandro Camacho | Azela Robinson | Uriel del Toro | Geraldine Bazan | Gabriela Roel | Marcus Ornellas'
), 
            ('s19', 
             'Adam Salky', 
'Freida Pinto | Logan Marshall-Green | Robert John Burke | Megan Elisabeth Kelly | Sarah Minnich | Hayes Hargrove | Mark Sivertsen | Brandon Fierro | Antonio Valles | Clint Obenchain'
            ...
            ('s20', 
             NULL, 
'Blanca Suarez | Ivan Marcos | Oscar Casas | Adrian Lastra | Francesc Garrido | Stefan Weinert | Julia Moller | Alicia Chojnowski'
); 
