/* Shows artist's loudest track, the loudness of that track, the average loudness across all the artist's tracks, then, categorizes 
the artist's average loudness and track loudness.*/
...
/*What track is the most likely to uplift mood? According to Rita Steblin in History of Key Characteristics in the Eighteenth and 
Early Nineteenth Centuries, F# major is associated with triumph over difficulty, therefore, song_key = 6.*/
SELECT artist_name, 
       track_name 
FROM   bit_db.spotifydata 
WHERE  song_mode = 1 
...
/*For this project, I downloaded Spotify data from Kaggle, created a table to insert the data into, and analyzed the data by asking 
questions and providing the insights listed above.*/
