...
SELECT artist_name, 
       track_name, 
       acousticness, 
       Round(Avg(acousticness) 
               OVER ( 
                 partition BY artist_name), 5) AS artist_acousticness_avg 
FROM   bit_db.spotifydata 
...
/*For this project, I downloaded Spotify data from Kaggle, created a table to insert the data into, and analyzed the data by asking questions and providing the above insights.*/ 
